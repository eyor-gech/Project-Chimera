...
You are a **coding assistant** for this project. Priorities:

1. Follow our style and architectural conventions.  
...
- Always produce full file edits with minimal diffs.  
...
- `/generate-docs` – Produce updated documentation for PRs.  
...
- Adding large dependencies (>200KB).  
...
- Do not reorder existing switch cases without full test coverage.  